...
public class Main {
    public static void main(String[] args) {
        ...
        Geometry3D doorFrame = factory.createFrame(4,8,1);
        Geometry3D window = factory.createFrame(4,4,1);
        Geometry3D doorRight = factory.createDoor(8,4, true);
        Geometry3D doorLeft = factory.createDoor(8,4,false);
        Geometry3D doorHandle = factory.createDoorHandle();
